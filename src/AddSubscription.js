    ...
    const handleSubmit = e => {
        ...
        return (
            ...
            <form className="addSubscription" onSubmit={handleSubmit}>
                ...
                <input required type="text" id="sub-name-input" name="sub-name-input" onChange= {(e) => setName(e.target.value)}></input>
                </div>

                <div className="sub_price">
                <label htmlFor="sub-price-input">Price</label>
                <input required type="number" step='0.01' id="sub-price-input" name="sub-price-input" value={price} onChange= {(e) => setPrice(e.target.value)}/>
                </div>

                <div className="sub_user">
                <label htmlFor="sub-username-input">Subscription Username</label>
                <input type="text" id="sub-username-input" name="sub-username-input" value={username} onChange= {(e) => setUsername(e.target.value)}/>
                </div>

                <div className="sub_password">
                <label htmlFor="sub-password-input">Subscription Password</label>
                <input type="text" id="sub-password-input" name="sub-password-input" value={password} onChange= {(e) => setPassword(e.target.value)}/>
                </div>

                <div className="sub_category">
                <label htmlFor="sub-category-input">Category</label>
                <select required id="sub-category-input" name="sub-category-input" value={category} onChange= {(e) => setCategory( e.target.value)}>
